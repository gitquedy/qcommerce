...
@section('myscript')
  ...
  <script type="text/javascript">
    function getHeaders(){
        $.ajax({
        method: "GET",
        url: "{{ action('ProductController@unlinkHeaders')  }}?site={{ $request->get('site') }}&shops=" + $("#shop").val(),
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $('input[name="site"]').change(function(){
        ...
        url = "{{ action('ProductController@unlink')}}?site=" + site;
