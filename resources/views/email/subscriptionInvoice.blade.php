...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <span class="preheader">This is an invoice for your subscription plan. Please submit payment by {{$business->subscription()->next_payment_date}}</span>
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                <a href="https://app.qcommerce.asia" class="f-fallback email-masthead_name">
                Qcommerce
              </a>
              </td>
            </tr>
            ...
            <tr>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>Thanks for using {{$business->subscription()->plan->name}} Plan of Qcommerce. This is an invoice for your subscription plan.</p>
              ...
              <strong>Amount Due:</strong> {{$business->subscription()->amount}}Php
                                ...
                                <tr>
                                  <td class="attributes_item">
                                    <span class="f-fallback">
              <strong>Due By:</strong> {{$business->subscription()->next_payment_date}}
            </span>
                                  </td>
                                </tr>
                              </table>
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">&copy; 2021 Qcommerce. All rights reserved.</p>
