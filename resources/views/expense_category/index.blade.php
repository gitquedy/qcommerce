      ...
      <div class="btn-dropdown mr-1 mb-1">
        <div class="btn-group dropdown actions-dropodown">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item massAction" href="#" data-action="{{ action('ExpenseCategoryController@massDelete') }}"> Delete</a>
...
@section('myscript')
  ...
  var buttons = [
            ...
            action: function() {
                window.location = '{{ action("ExpenseCategoryController@create") }}';
            },
