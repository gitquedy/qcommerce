    ...
    <table class="table table-borderless">
        ...
        <tr>
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="shop.manage" name="permissions[]">
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="order.manage" name="permissions[]" checked>
              <span class="vs-checkbox">
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="product.manage" name="permissions[]" checked>
              <span class="vs-checkbox">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="returnRecon.manage" name="permissions[]" checked>
              <span class="vs-checkbox">
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="payoutRecon.manage" name="permissions[]" checked>
              <span class="vs-checkbox">
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="shippingFeeRecon.manage" name="permissions[]" checked>
              <span class="vs-checkbox">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="sku.manage" name="permissions[]" checked>
              <span class="vs-checkbox">
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="brand.manage" name="permissions[]">
              <span class="vs-checkbox">
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="category.manage" name="permissions[]">
              <span class="vs-checkbox">
        ...
        <tr>
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="supplier.manage" name="permissions[]">
              <span class="vs-checkbox">
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="barcode.manage" name="permissions[]">
              <span class="vs-checkbox">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="user.manage" name="permissions[]">
              <span class="vs-checkbox">
                <span class="vs-checkbox--check"><i class="vs-icon feather icon-users"></i></span>
              </span>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <fieldset><div class="vs-checkbox-con vs-checkbox-primary">
              <input type="checkbox" value="report.manage" name="permissions[]">
              <span class="vs-checkbox">
