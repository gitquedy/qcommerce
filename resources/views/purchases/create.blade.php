      ...
      <div class="col-md-12 col-12">
          <div class="card">
              ...
              <div class="card-content">
                  <div class="card-body">
                      <form action="{{ action('PurchasesController@store') }}" method="POST" id="add_purchase_form" class="form" enctype="multipart/form-data">
                          @csrf
                          <div class="row">
                            <div class="col-md-3">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-left">
                                      <input type="number" name="shipping_fee" class="form-control update_input update_footer" placeholder="Shipping Fee" value="0">
                                      <div class="form-control-position"> 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-left">
                                      <input type="number" name="other_fees" class="form-control update_input update_footer" placeholder="Other Fee's" value="0">
                                      <div class="form-control-position"> 
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                    ...
                                    <div class="position-relative has-icon-left">
                                      <input type="number" name="discount" class="form-control update_input update_footer" placeholder="Discount Amount" value="0">
                                      <div class="form-control-position"> 
                                        <i class="feather icon-dollar-sign"></i>
                                      </div>
                                    </div>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        function reloadSales() {
          ...
          reOrderItems("purchase_items");
          var purchase_items = JSON.parse(localStorage.getItem("purchase_items"));
          var html = '';
          $("#sales_item_tables tbody").html(html);
          console.log(purchase_items);
          $.each(purchase_items.reverse(), function(i, data) {
        ...
        $(".search-input").on('typeahead:selected', function (event, datum, name) {
            $(this).typeahead("val", "");
            var purchase_items = {};
            if(localStorage.getItem("purchase_items")) {
              purchase_items = JSON.parse(localStorage.getItem("purchase_items"));            
            }
            var item_index = purchase_items.length;
            var list_item_index = Object.values(purchase_items).findIndex((si => si.id == datum.id));
            if(list_item_index == -1) {
              purchase_items[item_index] = {};
              purchase_items[item_index]['id']  = datum.id;
              purchase_items[item_index]['code']  = datum.code;
              purchase_items[item_index]['name']  = datum.name;
              purchase_items[item_index]['brand']  = datum.brand;
              purchase_items[item_index]['cost']  = datum.cost;
              purchase_items[item_index]['price']  = datum.price;
              purchase_items[item_index]['quantity']  = 1;
              purchase_items[item_index]['image']  = datum.image;
            }
            else if(purchase_items[list_item_index]['quantity'] < datum.quantity) {
              purchase_items[list_item_index]['quantity']++;
            }
        ...
        $(document).on('change', '.change_sku', function() {
            ...
            var val = $(this).val();
            var purchase_items = JSON.parse(localStorage.getItem("purchase_items")).reverse();
            purchase_items[id][name] = val;
            localStorage.setItem("purchase_items", JSON.stringify(purchase_items.reverse()));
