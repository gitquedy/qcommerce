        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('billing.approvePayment') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-right">
                                <br>
                                <button class="btn btn-primary" {{($billing->paid_status!=5)?'disabled':''}}>Approve Payment</button>
                            </div>
                        </div>
                    </form>
                </div>
