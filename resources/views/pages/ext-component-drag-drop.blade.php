          ...
          <div class="card-body">
            ...
            <ul class="list-group" id="basic-list-group">
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/portrait/small/avatar-s-12.png') }}" class="rounded-circle mr-2"
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/portrait/small/avatar-s-1.png') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/portrait/small/avatar-s-2.png') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/portrait/small/avatar-s-3.png') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/portrait/small/avatar-s-4.png') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
