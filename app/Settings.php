...
class Settings extends Model
{
     ...
     */
    protected $fillable = [
        'sales_prefix', 'quote_prefix', 'purchase_prefix', 'transfer_prefix', 'delivery_prefix', 'payment_prefix', 'return_prefix', 'adjustment_prefix', 'inventory_prefix', 'customer_name_format', 'business_id', 'expense_prefix', 'calendar_filter'
    ];
