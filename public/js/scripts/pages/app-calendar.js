...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function eventClick(info) {
    ...
    sidebar.find(eventLabel).val(eventToUpdate.extendedProps.label).trigger('change');
    ...
    $.ajax(
      {
        ...
        success: function (result) {
          ...
          successCallback(result.filter(event => calendars.includes(event.label.toLowerCase())));
        },
  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    eventClassNames: function ({ event: calendarEvent }) {
      // console.log(calendarEvent._def.extendedProps.label);
      const colorName = calendarsColor[calendarEvent._def.extendedProps.label];
    ...
    dateClick: function (info) {
      var date = moment(info.date).format('YYYY-MM-DD h:mm');
      resetValues();
      sidebar.modal('show');
  ...
  function updateEvent(eventData) {
    ...
    var extendedPropsToUpdate = ['label', 'guests', 'location', 'description'];
