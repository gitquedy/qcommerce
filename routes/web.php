...
Route::group(['middleware' => 'auth'], function()
{
	...
	Route::group(['middleware' => 'permission:sku.manage'], function()
	{
		...
		Route::get('/sku/skuproductsset/{sku}', 'SkuController@skuproductsset')->name('sku.skuproductsset');
		Route::post('/sku/ajaxlistsku', 'SkuController@ajaxlistsku')->name('sku.ajaxlistsku');
		Route::post('/sku/addproduct/', 'SkuController@addproduct')->name('sku.addproduct');
		Route::post('/sku/addproductset/', 'SkuController@addproductset')->name('sku.addproductset');
		Route::post('/sku/addproductmodal/', 'SkuController@addproductmodal')->name('sku.addproductmodal');
		Route::post('/sku/addproductsetmodal/', 'SkuController@addproductsetmodal')->name('sku.addproductsetmodal');
		Route::post('/sku/removeskuproduct/', 'SkuController@removeskuproduct')->name('sku.removeskuproduct');
		Route::post('/sku/removeskuproductset/', 'SkuController@removeskuproductset')->name('sku.removeskuproductset');
