...
Route::group(['middleware' => 'auth'], function()
{
	...
	Route::get('/billing/proof/{billing_id}', 'BillingController@viewProofOfPayment')->name('billing.viewProof');
	...
	Route::group(['middleware' => 'permission:warehouse.manage'], function()
	{
		...
		Route::get('/warehouse/viewInventory/{warehouse}', 'WarehouseController@viewInventory')->name('warehouse.viewInventory');
	});
